...
Source0:        http://tarballs.openstack.org/ironic/ironic-%{version}%{?milestone}.tar.gz
...
%changelog
* Tue May 23 2017 Alfredo Moralejo <amoralej@redhat.com> 1:5.1.3-1
- Update to 5.1.3

* Wed Jun 22 2016 Haikel Guemar <hguemar@fedoraproject.org> 1:5.1.2-1
- Update to 5.1.2

* Fri Jun 17 2016 Haikel Guemar <hguemar@fedoraproject.org> 1:5.1.1-1
- Update to 5.1.1

* Thu Mar 24 2016 RDO <rdo-list@redhat.com> 5.1.0-1
- 5.1.0 Rebuild for Mitaka
