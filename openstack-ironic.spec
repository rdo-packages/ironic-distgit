...
%changelog
* Thu Jun 06 2019 RDO <dev@lists.rdoproject.org> 1:11.1.3-1
- Update to 11.1.3

* Tue Jan 29 2019 RDO <dev@lists.rdoproject.org> 1:11.1.2-1
- Update to 11.1.2

* Fri Dec 21 2018 RDO <dev@lists.rdoproject.org> 1:11.1.1-1
- Update to 11.1.1

* Thu Aug 16 2018 RDO <dev@lists.rdoproject.org> 1:11.1.0-1
- Update to 11.1.0

# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/ironic/commit/?id=60d24ec9429f222bdae831b98bd0d3e6eb36d853
