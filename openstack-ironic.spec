...
%changelog
* Thu May 02 2024 RDO <dev@lists.rdoproject.org> 1:21.1.2-1
- Update to 21.1.2

* Thu Feb 08 2024 RDO <dev@lists.rdoproject.org> 1:21.1.1-1
- Update to 21.1.1

* Fri Sep 23 2022 RDO <dev@lists.rdoproject.org> 1:21.1.0-1
- Update to 21.1.0

* Fri Sep 16 2022 RDO <dev@lists.rdoproject.org> 1:21.0.0-1
- Update to 21.0.0

# REMOVEME: error caused by commit https://opendev.org/openstack/ironic/commit/d0fb7bce54e9d241a4442ef2347ac51ee1f4d7af
