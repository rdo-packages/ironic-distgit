...
oslopolicy-sample-generator-%{pyver} --config-file tools/policy/ironic-policy-generator.conf --format json --output-file %{buildroot}/%{_sysconfdir}/ironic/policy.json
...
%changelog
* Wed Apr 28 2021 Steve Baker <sbaker@redhat.com> 1:13.0.7-2
- Generate policy.json in json format

* Tue Feb 16 2021 RDO <dev@lists.rdoproject.org> 1:13.0.7-1
- Update to 13.0.7

* Thu Aug 20 2020 RDO <dev@lists.rdoproject.org> 1:13.0.6-1
- Update to 13.0.6

* Wed Jul 08 2020 RDO <dev@lists.rdoproject.org> 1:13.0.5-1
- Update to 13.0.5

* Fri Jun 19 2020 RDO <dev@lists.rdoproject.org> 1:13.0.4-1
- Update to 13.0.4

* Mon Mar 09 2020 RDO <dev@lists.rdoproject.org> 1:13.0.3-1
- Update to 13.0.3

* Mon Oct 28 2019 RDO <dev@lists.rdoproject.org> 1:13.0.2-1
- Update to 13.0.2

* Fri Oct 11 2019 RDO <dev@lists.rdoproject.org> 1:13.0.1-1
- Update to 13.0.1

* Mon Sep 30 2019 RDO <dev@lists.rdoproject.org> 1:13.0.0-1
- Update to 13.0.0
