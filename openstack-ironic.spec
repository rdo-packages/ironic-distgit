...
%package -n openstack-ironic-dnsmasq-tftp-server
Summary:    tftp-server service for ironic using dnsmasq

Requires:   %{name} = %{version}-%{release}
Requires:   dnsmasq

%description -n openstack-ironic-dnsmasq-tftp-server
...
%files -n openstack-ironic-dnsmasq-tftp-server
%license LICENSE
%{_unitdir}/openstack-ironic-dnsmasq-tftp-server.service

%post -n openstack-ironic-dnsmasq-tftp-server
%systemd_post openstack-ironic-dnsmasq-tftp-server.service

%preun -n openstack-ironic-dnsmasq-tftp-server
%systemd_preun openstack-ironic-dnsmasq-tftp-server.service

%postun -n openstack-ironic-dnsmasq-tftp-server
