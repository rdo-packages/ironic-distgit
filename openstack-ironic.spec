...
%changelog
* Thu Feb 01 2024 RDO <dev@lists.rdoproject.org> 1:20.1.3-1
- Update to 20.1.3

* Thu Sep 21 2023 RDO <dev@lists.rdoproject.org> 1:20.1.2-1
- Update to 20.1.2

* Mon Nov 07 2022 RDO <dev@lists.rdoproject.org> 1:20.1.1-1
- Update to 20.1.1

* Thu Mar 24 2022 RDO <dev@lists.rdoproject.org> 1:20.1.0-1
- Update to 20.1.0

* Tue Mar 22 2022 RDO <dev@lists.rdoproject.org> 1:20.0.0-1
- Update to 20.0.0

# REMOVEME: error caused by commit https://opendev.org/openstack/ironic/commit/a859de61de7aa5beb309dcc933b584a1f7a0d1e7
