...
oslopolicy-sample-generator-3 --config-file tools/policy/ironic-policy-generator.conf --output-file %{buildroot}/%{_sysconfdir}/ironic/policy.json
...
Requires:   python3-scciclient >= 0.5.0
