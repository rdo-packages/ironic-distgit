...
%changelog
* Mon Oct 21 2024 RDO <dev@lists.rdoproject.org> 1:21.4.4-1
- Update to 21.4.4

* Thu Sep 12 2024 RDO <dev@lists.rdoproject.org> 1:21.4.3-1
- Update to 21.4.3

* Mon Aug 05 2024 RDO <dev@lists.rdoproject.org> 1:21.4.2-1
- Update to 21.4.2

* Thu May 02 2024 RDO <dev@lists.rdoproject.org> 1:21.4.1-1
- Update to 21.4.1

* Mon Mar 13 2023 RDO <dev@lists.rdoproject.org> 1:21.4.0-1
- Update to 21.4.0

# REMOVEME: error caused by commit https://opendev.org/openstack/ironic/commit/30a8baa7c06df76f3d4caf841f1b6c276da34d5c
