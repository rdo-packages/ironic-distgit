...
BuildRequires:  python2-proliantutils
...
Requires:   python2-ironic-inspector-client >= 1.5.0
...
Requires:   python2-proliantutils >= 2.4.0
...
Requires:   python2-UcsSdk >= 0.8.2.2
