...
%changelog
* Tue Oct 25 2022 RDO <dev@lists.rdoproject.org> 1:17.1.0-1
- Update to 17.1.0

* Thu Oct 07 2021 RDO <dev@lists.rdoproject.org> 1:17.0.4-1
- Update to 17.0.4

* Wed Jun 23 2021 RDO <dev@lists.rdoproject.org> 1:17.0.3-1
- Update to 17.0.3

* Fri Apr 30 2021 RDO <dev@lists.rdoproject.org> 1:17.0.2-1
- Update to 17.0.2

* Thu Apr 08 2021 RDO <dev@lists.rdoproject.org> 1:17.0.1-1
- Update to 17.0.1


# REMOVEME: error caused by commit https://opendev.org/openstack/ironic/commit/a3b59814706424debd3848d2e7cd79566b646619
